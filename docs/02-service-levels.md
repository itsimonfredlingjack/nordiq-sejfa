...
- Submit — Medarbetaren skickar in ärendet via Teams, e-post eller webbportal.
- Triage — NordIQ klassificerar ärendet automatiskt (FAQ / Incident / Request / Change).
- Fulfill — AI-agenten löser 40–60 % av inkommande ärenden.
- Eskalering — Resterande ärenden skickas till Anna (IT Ops) inom 2 minuter (kopplat till SLO 4).
- Verify and close — Ärendet markeras som löst, användaren bekräftar eller ticket stängs automatiskt.
...
flowchart LR
    ...
    D --> H["Escalering till IT Ops (vid behov)"]
    H --> E
```
